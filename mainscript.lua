-- =====================================================================
-- ULTIMATE ANDROID D3D MENU: CLEAN UI DESIGN & BUTTON LAYOUT ONLY
-- =====================================================================
...
-- POPULATE TABS WITH CLEAN UI COMPONENTS ONLY
CreateToggle(TabContentFrames["Visual"], "ESP Line (Top Center)")
CreateToggle(TabContentFrames["Visual"], "ESP Name")
CreateToggle(TabContentFrames["Visual"], "ESP Distance")
CreateToggle(TabContentFrames["Visual"], "ESP Gender [Cowo/Cewe]")
CreateToggle(TabContentFrames["Visual"], "ESP Item Nearby")
CreateSlider(TabContentFrames["Visual"], "ESP Item Radius")
CreateToggle(TabContentFrames["Visual"], "Chams Body Color (Glow)")
CreateColorPicker(TabContentFrames["Visual"], "Chams Circle Color Picker")

...
-- Fitur Baru Ditambahkan Kembali: Infinite Jump
CreateToggle(TabContentFrames["Player"], "Infinite Jump (Loncat Terus)", false, function(v)
    HackConfig.InfiniteJumpAktif = v
    ShowPopupNotification(v and "Infinite Jump Diaktifkan" or "Infinite Jump Dimatikan")
end)

UserInputService.JumpRequest:Connect(function()
    if HackConfig.InfiniteJumpAktif and LocalPlayer.Character then
...
-- Fitur Baru Ditambahkan Kembali: Fullbright
CreateToggle(TabContentFrames["World"], "Fullbright (Anti Gelap Total)", false, function(v)
    WorldConfig.Fullbright = v
    ShowPopupNotification(v and "Fullbright Diaktifkan" or "Fullbright Dimatikan")
end)
